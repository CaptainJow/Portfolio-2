    ...
    <div className="card">
      <div className="box">
        <div className="content">
          ...
          <p>Computer science faculty with a 4 year batchelor degree, this is where my Computer software engineering life starts .</p>
    ...
    <div className="card">
      <div className="box">
        <div className="content">
          ...
          <p>I was here as an Exchange Student when I participated in the Erasmus Program , I practiced my how to deploy and make projects from scratch here</p>
